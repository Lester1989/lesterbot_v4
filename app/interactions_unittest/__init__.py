...
class DeferAction(BaseAction):
    ...
    def __init__(self, ephemeral: bool):
        ...
        print(f"DeferAction {self.creation_time}")
        print(f"DeferAction {time.time_ns()}")
...
class SendAction(BaseAction):
    ...
    def __init__(self, message: dict):
        ...
        print(f"SendAction {self.creation_time}")
        print(f"SendAction {time.time_ns()}")
...
class DeleteAction(BaseAction):
    ...
    def __init__(self, message_id: int):
        ...
        print(f"DeleteAction {self.creation_time}")
        print(f"DeleteAction {time.time_ns()}")
...
class EditAction(BaseAction):
    ...
    def __init__(self, message: dict):
        super().__init__()
        self.message = message
        print(f"EditAction {self.creation_time}")
        print(f"EditAction {time.time_ns()}")
