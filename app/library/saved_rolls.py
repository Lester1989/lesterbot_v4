...
class SavedRoll(SQLModel, table=True):
    ...
    def is_available(self,server_id:str,category_id:str,channel_id:str)->bool:
        return (self.scope == 'server' and self.discord_id == server_id
                or self.scope == 'category' and self.discord_id == category_id
                or self.scope == 'channel' and self.discord_id == channel_id)
